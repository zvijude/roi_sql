...
export default function Filter({ query, fields }) {
  ...
  return (
    <div popover='auto' className='pop max-h-[75vh] w-[560px] scroll-bar overflow-y-auto' id='filterPop'>
        ...
        <section className='grid grid-cols-2 gap-4'>
          ...
          <div>
            ...
            <Input
              ...
              name='fromDate_com'
              defaultValue={
                query?.completedAt?.gte ? new Date(query?.completedAt?.gte).toISOString().split('T')[0] : ''
              }
              required={false}
            />
            <Input
              ...
              name='toDate_com'
              defaultValue={
                query?.completedAt?.lte ? new Date(query?.completedAt?.lte).toISOString().split('T')[0] : ''
              }
              required={false}
            />
          </div>
