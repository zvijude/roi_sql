...
import { addMedida, deleteMedida } from './api'
  ...
  return (
    <>
      ...
      <form className='pop px-4 py-6 min-w-80 ' popover='auto' id='measureOptPop' onSubmit={onSubmit}>
        {!isEdit && (
          <div>
            <Select lbl='הוסף מידות במ"מ' name='measureItem' options={medidotOpt} placeholder='בחר סוג מידה' className='w-full' />
